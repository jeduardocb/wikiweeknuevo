...
<div class="container text-center">
    ...
    <a href="listadoCepa.php"> <button type="button" class="btn btn-info">Modificar Cepas</button></a><br>
    <hr>
    <a href="addTerpeno.php"> <button type="button" class="btn btn-info">Agregar/Modificar Terpenos</button></a><br>
    <hr>
